                                            ...
                                            <div class="col-md">
                                                <div>
                                                    ...
                                                    <div class="hstack gap-3 flex-wrap">
                                                        <div><i class="ri-building-line align-bottom me-1"></i> KFTD
                                                        </div>
                                                        <div class="vr"></div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-muted mt-4">
                                                ...
                                                <ul class="ps-4 vstack gap-2">
                                                    <li>
                                                        <div>
                                                            <h5 class="fs-15 mb-1">Gembong Addy Prabowo</h5>
                                                            <p class="fs-13 text-muted mb-0">Unit SDM</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="vstack gap-2">
                                                @forelse ($laporan->fileBukti as $item)
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-shrink-0 ms-2">
                                                                <div class="d-flex gap-1">
                                                                    <button type="button"
                                                                        onclick="download('{{ route('file.download', ['filePath' => $item->path]) }}')"
