                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value"
                                                data-target="{{ $pengaduan->count() }}">0</span></h2>
                    ...
                    <div class="col-xxl-3 col-sm-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <p class="fw-semibold text-muted mb-0">Pengaduan Proses</p>
                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value"
                                                data-target="{{ $pengaduan->whereIn('status', [2, 3, 4, 5])->count() }}">0</span>
                                        </h2>
                        ...
                        <div class="card-body">
                            <div class="table-responsive table-card mb-4">
                                <table class="table align-middle table-nowrap mb-0" id="ticketTable"
                                    @if ($pengaduan->count() <= 1) style="height: 300px;" @endif>
                                    <thead>
                                        <tr>
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <li>
                                                                    <button class="dropdown-item"
                                                                        @if ($row->status !== 1 && Auth::user()->getRoleName() !== 'Admin') disabled @endif
