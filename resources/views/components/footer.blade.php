    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-4 col-sm-6 mb-4 mb-xl-0 single-footer-widget">
                ...
                <a class="navbar-brand logo_h d-none d-xl-block" href="index.html"><img
            ...
            <div class="col-xl-4 col-sm-6 mb-4 mb-xl-0 single-footer-widget">
                ...
                <ul>
                    ...
                    <li><a href="tel:+88044338899">Phone: (021) 3456959</a></li>
                    <li><a href="mailto:info@colorlib.com">Email: business@kftd.co.id</a></li>
                </ul>
            </div>
            <div class="col-xl-4 col-sm-6 mb-4 mb-xl-0 single-footer-widget">
        ...
        <div class="footer-bottom row align-items-center text-center text-lg-left">
            <p class="footer-text m-0 col-lg-8 col-md-12">
                ...
                IT <a href="https://kftd.co.id/">KFTD</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
